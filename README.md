...
* The GET Target and Comment endpoints are cached for 2 minutes. The upside is that this will be performant in general. The downside is that new comments may not show for 2 minutes.
